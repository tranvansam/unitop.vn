        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        ...
                        <form method="GET" class="form-s fl-right form-actions">
                            ...
                            Search by <select name="search_by" id="">
                                ...
                                <option value="post_title" <?php if (!empty($search_by) && $search_by == "post_title") {
                                                                echo "selected";
                                                            } ?>>Tiêu đề</option>
                    ...
                    <form action="?mod=post&action=delete" method="POST">
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    if (empty($search_value)) {
                        ...
                        echo get_pagging($num_page, $page, "?mod=post&search_by={$search_by}&search_value={$search_value}&search=searched");
                    }
                    ?>
                </div>
            </div>
